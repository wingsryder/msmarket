        ...
        with st.spinner("Collecting and processing data..."):
            try:
                ...
                if raw_data is None or raw_data.empty:
                    ...
                    st.error("• Using a shorter date range (1-2 weeks)")
                    st.error("• Waiting 5-10 minutes (API rate limiting)")
                ...
                processed_data = processor.calculate_rolling_statistics(processed_data)
                ...
                if "No data could be fetched" in error_msg:
                    ...
                    st.error("1. 🕐 Wait 5-10 minutes (Yahoo Finance rate limiting)")
                    st.error("2. 📅 Try a shorter date range (1-2 weeks)")
                    st.error("3. 🎯 Select fewer sectors (1-2 sectors)")
